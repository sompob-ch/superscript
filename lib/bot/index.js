...
class SuperScript {
  ...
  importJSON(obj, callback) {
    ...
    _import2.default.importData(this.chatSystem, obj, callback);
  }
...
class SuperScriptInstance {
  ...
  getBot(tenantId, conversationTimeout = 0) {
    ...
    return new SuperScript(this.coreChatSystem, this.coreFactSystem, this.plugins, this.scope, this.editMode, customConversationTimeout, this.historyCheckpoints, tenantId);
  }
}
